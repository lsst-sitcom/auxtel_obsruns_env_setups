...
# This script is ONLY to be used for the AuxTel run of 2022-05B
source ${LOADSTACK}

## Verify the proper build cycle is used
LSST_IMAGE='w_2022_25_c0026.000'
...
REQUIRED_BUILD='lsst-scipipe-4.0.1'
