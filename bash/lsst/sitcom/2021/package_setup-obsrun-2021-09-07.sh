...
# This script is ONLY to be used for the AuxTel run of 2021-09-07
source ${LOADSTACK}

## Verify the proper build cycle is used
LSST_IMAGE='w_2021_35_c0021.005'
...
git fetch --all
git checkout tickets/DM-31639
git reset origin/tickets/DM-31639 --hard
git pull
setup -j -r .
