...
# This script is ONLY to be used for the AuxTel run of 2022-01A
source ${LOADSTACK}

## Verify the proper build cycle is used
LSST_IMAGE='w_2023_01_c0028.004'
...
REQUIRED_BUILD='lsst-scipipe-5.1.0'
...
LSST_DISTRIB_VER=${LSST_IMAGE:0:9}
