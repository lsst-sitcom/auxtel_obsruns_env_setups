...
LSST_IMAGE='w_2021_48_c0022.007'
...
REQUIRED_BUILD='lsst-scipipe-0.7.0'
...
setup -j -r .
git fetch --all
git checkout tickets/DM-32596
git reset origin/tickets/DM-32596 --hard
git pull
scons opt=3 -j 4
...
git fetch --all
git checkout tickets/DM-32748
git reset origin/tickets/DM-32748 --hard
git pull
setup -j -r .
